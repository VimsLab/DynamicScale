...
parser.add_argument('--model', default='pointnet2_cls_ssg_half', help='Model name [default: pointnet2_cls_ssg]')

parser.add_argument('--log_dir', default='range75', help='Log dir [default: log]')
...
parser.add_argument('--train_file', default = '../training_data/h5_files/main_split/training_objectdataset_augmentedrot_scale75.h5', help='Location of training file')
parser.add_argument('--test_file', default = '../training_data/h5_files/main_split/test_objectdataset_augmentedrot_scale75.h5', help='Location of test file')
...
def train():
    with tf.Graph().as_default():
        ...
        for epoch in range(MAX_EPOCH):
            ...
            eval_one_epoch(sess, ops, test_writer, saver)
...
def eval_one_epoch(sess, ops, test_writer, saver):
    """ ops: dict mapping from string to tf ops """
    is_training = False
    total_correct = 0
    total_seen = 0
    ...
    global best_acc
    if best_acc < (total_correct / float(total_seen)):
