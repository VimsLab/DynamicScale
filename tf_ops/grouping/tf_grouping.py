...
def query_ellipsoid_point(e1,e2,e3, nsample, xyz1, xyz2):
    return grouping_module.query_ellipsoid_point(xyz1, xyz2, e1,e2,e3, nsample)
ops.NoGradient('QueryEllipsoidPoint')
